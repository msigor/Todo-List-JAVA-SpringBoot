...
public static List<Task> createTasks() {
        ...
        Task task1 = new Task("Descrição da Tarefa 1", TaskType.DATA, TaskPriority.ALTA, null);
        ...
        Task task2 = new Task("Descrição da Tarefa 2", TaskType.PRAZO, TaskPriority.MEDIA, null);
